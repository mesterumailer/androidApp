...
10. ارسال چندقسمتی SMS و بررسی اینکه قطعه‌ها به یک پیام واحد تبدیل می‌شوند.
11. دریافت دوباره همان Intent و بررسی جلوگیری از duplicate notification.

این مرحله «تست دستگاه واقعی» است و موفقیت آن باید جدا از Unit Test و Build CI ثبت شود.
