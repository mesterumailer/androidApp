...
> وضعیت فعلی: نسخه `0.6.0` — فیلتر مسدودسازی پیش از دسته‌بندی، قابل تست
...
- فیلتر مسدودسازی برای شماره/فرستنده و عبارت محتوایی قبل از Classification اجرا می‌شود و پیام‌های مسدودشده اصلاً برای دسته‌بندی وارد نمی‌شوند.
