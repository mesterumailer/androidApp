...
> وضعیت فعلی: نسخه `0.4.1` — فاز ۱.۱، قابل تست
...
- انتخاب تم روشن یا تاریک از داخل Settings با ذخیره ماندگار انتخاب کاربر و پالت رنگی مناسب خوانایی.
...
- [x] تم روشن و تاریک با انتخاب از Settings
