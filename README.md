...
- اعلان هر دسته مستقل است و کاربر می‌تواند یک صدای موجود روی گوشی را برای آن انتخاب کند؛ پیش‌فرض هر دسته بدون صداست، ویبره نداریم و میزان صدا از تنظیمات Notification خود Android پیروی می‌کند.
